...
class CommentForm(FlaskForm):
    ...
    """
    content = TextAreaField("Leave your comment here", validators=[DataRequired("You must give some text comment."), Length(1, 500)])  # comment text
    ...
    rate = StringField(validators=[DataRequired("You should rate it.")])   # the rate (star num) should be put into the "value" of this field
